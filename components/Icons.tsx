...
export const SparklesIconSmall: React.FC = () => (
...
export const UploadIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M7 16a4 4 0 01-4-4V7a4 4 0 014-4h10a4 4 0 014 4v5a4 4 0 01-4 4H7zM16 16v1.5a2.5 2.5 0 005 0V16" />
...
export const ZipIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M4 7v10c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V7" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M8 7V5c0-1.1.9-2 2-2h4c1.1 0 2 .9 2 2v2" />
...
export const PhoneCaseIcon: React.FC = () => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-full h-full">
    <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 1.5H5.625A2.625 2.625 0 003 4.125v15.75A2.625 2.625 0 005.625 22.5h8.25A2.625 2.625 0 0016.5 19.875V16.5m-6 0h5.25m-5.25 0h-3.375" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 1.5a2.625 2.625 0 012.625 2.625v2.625a2.625 2.625 0 01-5.25 0V4.125C13.875 2.625 15.125 1.5 16.5 1.5z" />
  </svg>
);

export const PosterIcon: React.FC = () => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-full h-full">
...
export const ToteBagIcon: React.FC = () => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-full h-full">
    <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 7.5V6.108c0-1.135.845-2.098 1.976-2.192.373-.03.748-.03 1.125 0 1.131.094 1.976 1.057 1.976 2.192V7.5M8.25 7.5h7.5m-7.5 0l-1.096 10.047a2.25 2.25 0 002.24 2.453h6.712a2.25 2.25 0 002.24-2.453L15.75 7.5h-7.5z" />
  </svg>
);

export const CustomProductIcon: React.FC = () => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-full h-full">
